...
const TechnologiesPage = () => {
    ...
    return (
        <div className="container mx-auto p-4 dark:bg-slate-950 dark:bg-opacity-50 backdrop-filter backdrop-blur-md mb-6 max-w-7xl">
            <div className="mx-auto p-4 dark:bg-slate-900 dark:bg-opacity-50 backdrop-filter backdrop-blur-md rounded-tl-lg shadow-md mb-6">
